...
class CollectionFollowUp(BaseModel):
    ...
    collection_stage: Mapped[CollectionStage] = mapped_column(
        String(50), nullable=False
    )
    ...
    # Assignment
    assigned_to_id: Mapped[Optional[UUID]] = mapped_column(PGUUID(as_uuid=True))
    assigned_to_name: Mapped[Optional[str]] = mapped_column(String(200))

    # Execution
    status: Mapped[FollowUpStatus] = mapped_column(
        String(50), default=FollowUpStatus.SCHEDULED
    )
    executed_date: Mapped[Optional[datetime]] = mapped_column(DateTime)
    outcome: Mapped[Optional[FollowUpOutcome]] = mapped_column(String(50))

    # PTP Details (Promise to Pay)
    ptp_date: Mapped[Optional[date]] = mapped_column(Date)
    ptp_amount: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 2))
...
class DemandNotice(BaseModel):
    ...
    # Delivery Details
    delivery_mode: Mapped[Optional[str]] = mapped_column(String(50))  # Registered Post, Courier, Hand
...
class NPARecord(BaseModel):
    ...
    classification_at_npa: Mapped[AssetClassification] = mapped_column(
        String(50), nullable=False
    )
    current_classification: Mapped[AssetClassification] = mapped_column(
        String(50), nullable=False
    )

    # Dates
    npa_date: Mapped[date] = mapped_column(Date, nullable=False)
    first_overdue_date: Mapped[Optional[date]] = mapped_column(Date)
    upgrade_date: Mapped[Optional[date]] = mapped_column(Date)
    ...
    # Security Value
    realizable_security_value: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 2))
    erosion_in_security: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 2))

    # Recovery
    total_recovery: Mapped[Decimal] = mapped_column(
        Numeric(18, 2), default=Decimal("0")
    )
    recovery_principal: Mapped[Decimal] = mapped_column(
        Numeric(18, 2), default=Decimal("0")
    )
    recovery_interest: Mapped[Decimal] = mapped_column(
        Numeric(18, 2), default=Decimal("0")
    )

    # Resolution
    resolution_strategy: Mapped[Optional[str]] = mapped_column(String(100))
...
class PenalInterest(BaseModel):
    ...
    # GL Reference
    gl_entry_reference: Mapped[Optional[str]] = mapped_column(String(100))
...
class PenalWaiver(BaseModel):
    ...
    __table_args__ = (
        Index("ix_col_penal_waiver_loan_account", "loan_account_id"),
    )
    ...
    approval_reference: Mapped[Optional[str]] = mapped_column(String(100))
...
class OTSProposal(BaseModel):
    ...
    status: Mapped[OTSStatus] = mapped_column(
        String(50), default=OTSStatus.DRAFT
    )
    ...
    # Waiver Breakdown
    principal_waiver: Mapped[Decimal] = mapped_column(
        Numeric(18, 2), default=Decimal("0")
    )
    interest_waiver: Mapped[Decimal] = mapped_column(
        Numeric(18, 2), default=Decimal("0")
    )
    penal_waiver: Mapped[Decimal] = mapped_column(
        Numeric(18, 2), default=Decimal("0")
    )
    charges_waiver: Mapped[Decimal] = mapped_column(
        Numeric(18, 2), default=Decimal("0")
    )

    # Payment Terms
    payment_mode: Mapped[OTSPaymentMode] = mapped_column(String(50), nullable=False)
    upfront_amount: Mapped[Decimal] = mapped_column(
        Numeric(18, 2), default=Decimal("0")
    )
    upfront_due_date: Mapped[Optional[date]] = mapped_column(Date)
    ...
    # Security Release
    security_release_terms: Mapped[Optional[str]] = mapped_column(Text)

    # Approval
    approved_by_id: Mapped[Optional[UUID]] = mapped_column(PGUUID(as_uuid=True))
    approved_by_name: Mapped[Optional[str]] = mapped_column(String(200))
    approval_date: Mapped[Optional[date]] = mapped_column(Date)
    approval_authority: Mapped[Optional[str]] = mapped_column(String(100))

    # Borrower Acceptance
    borrower_acceptance_date: Mapped[Optional[date]] = mapped_column(Date)
    borrower_acceptance_document: Mapped[Optional[str]] = mapped_column(String(500))
...
class OTSPaymentSchedule(BaseModel):
    ...
    receipt_reference: Mapped[Optional[str]] = mapped_column(String(100))
    ...
    # Relationships
    ots_proposal: Mapped["OTSProposal"] = relationship(
...
class LoanRestructure(BaseModel):
    ...
    restructure_type: Mapped[RestructureType] = mapped_column(
        String(50), nullable=False
    )
    status: Mapped[RestructureStatus] = mapped_column(
        String(50), default=RestructureStatus.DRAFT
    )
    proposal_date: Mapped[date] = mapped_column(Date, nullable=False)

    # Pre-Restructure Terms
    pre_outstanding_principal: Mapped[Decimal] = mapped_column(
        Numeric(18, 2), nullable=False
    )
    pre_outstanding_interest: Mapped[Decimal] = mapped_column(
        Numeric(18, 2), nullable=False
    )
    ...
    pre_emi_amount: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 2))
    pre_maturity_date: Mapped[date] = mapped_column(Date, nullable=False)

    # Post-Restructure Terms
    post_outstanding_principal: Mapped[Decimal] = mapped_column(
        Numeric(18, 2), nullable=False
    )
    ...
    post_emi_amount: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 2))
    ...
    moratorium_start_date: Mapped[Optional[date]] = mapped_column(Date)
    moratorium_end_date: Mapped[Optional[date]] = mapped_column(Date)
    moratorium_interest_treatment: Mapped[Optional[str]] = mapped_column(
        String(50)
    )  # CAPITALIZE, DEFER, WAIVE

    # Sacrifice/Relief
    interest_waived: Mapped[Decimal] = mapped_column(
        Numeric(18, 2), default=Decimal("0")
    )
    penal_waived: Mapped[Decimal] = mapped_column(
        Numeric(18, 2), default=Decimal("0")
    )
    ...
    # Conditions
    pre_conditions: Mapped[Optional[str]] = mapped_column(Text)
    post_conditions: Mapped[Optional[str]] = mapped_column(Text)
...
class LegalCase(BaseModel):
    ...
    status: Mapped[LegalCaseStatus] = mapped_column(
        String(50), default=LegalCaseStatus.DRAFT
    )
    ...
    claim_costs: Mapped[Decimal] = mapped_column(
        Numeric(18, 2), default=Decimal("0")
    )
    total_claim: Mapped[Decimal] = mapped_column(Numeric(18, 2), nullable=False)
    interest_rate_claimed: Mapped[Optional[Decimal]] = mapped_column(Numeric(8, 4))

    # SARFAESI Specific
    sarfaesi_stage: Mapped[Optional[SARFAESIStage]] = mapped_column(String(50))
    demand_notice_date: Mapped[Optional[date]] = mapped_column(Date)
    possession_date: Mapped[Optional[date]] = mapped_column(Date)
    possession_type: Mapped[Optional[str]] = mapped_column(String(50))  # PHYSICAL, SYMBOLIC

    # Decree/Order Details
    decree_date: Mapped[Optional[date]] = mapped_column(Date)
    decree_amount: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 2))
    decree_interest_rate: Mapped[Optional[Decimal]] = mapped_column(Numeric(8, 4))

    # Legal Representation
    advocate_name: Mapped[Optional[str]] = mapped_column(String(200))
    advocate_contact: Mapped[Optional[str]] = mapped_column(String(100))
    ...
    # Costs
    legal_costs_incurred: Mapped[Decimal] = mapped_column(
        Numeric(18, 2), default=Decimal("0")
    )
    court_fees_paid: Mapped[Decimal] = mapped_column(
        Numeric(18, 2), default=Decimal("0")
    )

    # Recovery
    recovery_through_case: Mapped[Decimal] = mapped_column(
        Numeric(18, 2), default=Decimal("0")
    )

    # Closure
    closure_date: Mapped[Optional[date]] = mapped_column(Date)
    closure_reason: Mapped[Optional[str]] = mapped_column(String(200))
...
class LegalHearing(BaseModel):
    ...
    # Court/Bench
    bench: Mapped[Optional[str]] = mapped_column(String(200))
    ...
    order_passed: Mapped[Optional[str]] = mapped_column(Text)
    ...
    # Documents
    documents_filed: Mapped[Optional[str]] = mapped_column(Text)
    documents_received: Mapped[Optional[str]] = mapped_column(Text)

    # Next Steps
    next_hearing_date: Mapped[Optional[date]] = mapped_column(Date)
    next_hearing_purpose: Mapped[Optional[str]] = mapped_column(String(200))
...
class PropertyAuction(BaseModel):
    ...
    loan_security_id: Mapped[Optional[UUID]] = mapped_column(
        PGUUID(as_uuid=True),
    ...
    status: Mapped[AuctionStatus] = mapped_column(
        String(50), default=AuctionStatus.SCHEDULED
    )
    ...
    property_area: Mapped[Optional[str]] = mapped_column(String(100))
    ...
    publication_details: Mapped[Optional[str]] = mapped_column(Text)
    newspapers: Mapped[Optional[str]] = mapped_column(Text)
    ...
    e_auction_portal: Mapped[Optional[str]] = mapped_column(String(200))

    # Bidding
    number_of_bidders: Mapped[int] = mapped_column(Integer, default=0)
    highest_bid: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 2))
    successful_bidder_name: Mapped[Optional[str]] = mapped_column(String(200))
    successful_bidder_address: Mapped[Optional[str]] = mapped_column(Text)

    # Sale
    sale_confirmed: Mapped[bool] = mapped_column(Boolean, default=False)
    sale_confirmation_date: Mapped[Optional[date]] = mapped_column(Date)
    sale_certificate_date: Mapped[Optional[date]] = mapped_column(Date)
    sale_amount: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 2))

    # Payment
    total_received: Mapped[Decimal] = mapped_column(
        Numeric(18, 2), default=Decimal("0")
    )
    balance_due: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 2))
...
class WriteOffRecord(BaseModel):
    ...
    status: Mapped[WriteOffStatus] = mapped_column(
        String(50), default=WriteOffStatus.PROPOSED
    )
    proposal_date: Mapped[date] = mapped_column(Date, nullable=False)
    ...
    penal_written_off: Mapped[Decimal] = mapped_column(
        Numeric(18, 2), default=Decimal("0")
    )
    total_written_off: Mapped[Decimal] = mapped_column(
        Numeric(18, 2), nullable=False
    )
    ...
    security_realized: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 2))
    shortfall: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 2))

    # Justification
    justification: Mapped[str] = mapped_column(Text, nullable=False)
    recovery_efforts: Mapped[Optional[str]] = mapped_column(Text)
    ...
    approval_date: Mapped[Optional[date]] = mapped_column(Date)
    approval_authority: Mapped[Optional[str]] = mapped_column(String(100))
    board_resolution_date: Mapped[Optional[date]] = mapped_column(Date)
    board_resolution_number: Mapped[Optional[str]] = mapped_column(String(100))
    ...
    recovery_after_write_off: Mapped[Decimal] = mapped_column(
        Numeric(18, 2), default=Decimal("0")
    )

    # Write-back
    write_back_date: Mapped[Optional[date]] = mapped_column(Date)
    write_back_amount: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 2))
    write_back_reason: Mapped[Optional[str]] = mapped_column(Text)
