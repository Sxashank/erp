...
from app.api.v1.fixed_assets.disposals import router as disposals_router
...
router.include_router(
    it_depreciation_router, prefix="/it-depreciation", tags=["IT Act Depreciation"]
)
router.include_router(pv_router, prefix="/verification", tags=["Physical Verification"])
router.include_router(disposals_router, prefix="/disposals", tags=["Disposal Register"])
