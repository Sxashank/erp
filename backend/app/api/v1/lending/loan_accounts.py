...
@router.get(
    "",
    response_model=PaginatedResponse[LoanAccountListResponse],
    response_model_by_alias=True,  # serialise list items as camelCase per CamelSchema
)
...
@router.get(
    "/summary",
    response_model=LoanAccountSummary,
...
@router.get(
    "/{loan_account_id}",
    response_model=LoanAccountViewResponse,
    response_model_by_alias=True,
)
async def get_loan_account(
    ...
    """Get loan account by ID (camelCase view shape with joined entity/product names)."""
    service = LoanAccountService(db)
    account = await service.get_loan_account_with_relations(loan_account_id)
    return LoanAccountViewResponse.model_validate(account)


@router.get(
    "/{loan_account_id}/details",
...
@router.get(
    "/{loan_account_id}/disbursements",
    response_model=list[DisbursementResponse],
    response_model_by_alias=True,
)
...
@router.post(
    "/disbursements/{disbursement_id}/approve",
    response_model=DisbursementResponse,
    response_model_by_alias=True,
)
...
@router.post(
    "/disbursements/{disbursement_id}/process",
    response_model=DisbursementResponse,
    response_model_by_alias=True,
)
async def process_disbursement(
    ...
    service = LoanAccountService(db)
    disbursement = await service.process_disbursement(
        disbursement_id, process_data, current_user.id
    )
    return DisbursementResponse.model_validate(disbursement)
...
@router.get(
    ...
    response_model=RepaymentScheduleDetailResponse,
    response_model_by_alias=True,
)
...
@router.post(
    "/{loan_account_id}/schedule",
    response_model=RepaymentScheduleResponse,
    response_model_by_alias=True,
)
...
@router.get(
    "/{loan_account_id}/receipts",
    response_model=list[LoanReceiptResponse],
    response_model_by_alias=True,
)
...
@router.post(
    "/{loan_account_id}/receipts",
    response_model=LoanReceiptResponse,
    response_model_by_alias=True,
)
...
@router.get(
    "/{loan_account_id}/mandates",
    response_model=list[LoanMandateResponse],
    response_model_by_alias=True,
)
...
@router.post(
    "/{loan_account_id}/mandates",
    response_model=LoanMandateResponse,
    response_model_by_alias=True,
)
...
@router.get(
    "/{loan_account_id}/classification-history",
    response_model=list[AssetClassificationHistoryResponse],
    response_model_by_alias=True,
)
...
@router.post(
    "/{loan_account_id}/update-classification",
    response_model=LoanAccountResponse,
    response_model_by_alias=True,
)
...
@router.post(
    "/{loan_account_id}/accrual",
    response_model=LoanAccrualResponse,
    response_model_by_alias=True,
)
...
@router.post(
    "/{loan_account_id}/provision",
    response_model=LoanProvisionResponse,
    response_model_by_alias=True,
)
...
@router.get(
    "/{loan_account_id}/adjustments",
    response_model=list[LoanAdjustmentResponse],
    response_model_by_alias=True,
)
...
@router.post(
    "/{loan_account_id}/adjustments",
    response_model=LoanAdjustmentResponse,
    response_model_by_alias=True,
)
