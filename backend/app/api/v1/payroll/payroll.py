...
@router.get("/statutory-setup", response_model=List[StatutorySetupResponse])
async def list_statutory_setup(
    ...
    items = await service.list(organization_id, statutory_type)
    return [StatutorySetupResponse.model_validate(item) for item in items]


@router.post("/statutory-setup", response_model=StatutorySetupResponse, status_code=status.HTTP_201_CREATED)
...
@router.get("/statutory-setup/{id}", response_model=StatutorySetupResponse)
...
@router.put("/statutory-setup/{id}", response_model=StatutorySetupResponse)
...
@router.post("/batches", response_model=PayrollBatchResponse, status_code=status.HTTP_201_CREATED)
...
@router.get("/batches/{id}", response_model=PayrollBatchResponse)
...
@router.put("/batches/{id}", response_model=PayrollBatchResponse)
...
@router.post("/batches/{id}/process", response_model=PayrollBatchResponse)
...
@router.post("/batches/{id}/approve", response_model=PayrollBatchResponse)
...
@router.post("/batches/{id}/mark-paid", response_model=PayrollBatchResponse)
...
@router.put("/payslips/{id}", response_model=PayslipResponse)
...
@router.get("/payslips/employee/{employee_id}", response_model=dict)
