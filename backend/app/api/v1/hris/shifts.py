...
@router.put("/holiday-calendars/{calendar_id}", response_model=HolidayCalendarResponse)
...
@router.post("/holidays/bulk", response_model=List[HolidayResponse], status_code=status.HTTP_201_CREATED)
@RequirePermissions([Permissions.HRIS_HOLIDAY_CREATE])
...
# Utility Endpoints
# ============================================
@router.get("/check-holiday", response_model=Optional[HolidayResponse])
@RequirePermissions([Permissions.HRIS_HOLIDAY_VIEW])
