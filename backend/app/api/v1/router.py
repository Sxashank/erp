...
api_router.include_router(org_bank_accounts_router, prefix="/organizations", tags=["Organization Bank Accounts"])
api_router.include_router(org_addresses_router, prefix="/organizations", tags=["Organization Addresses"])
...
# Finance routes
api_router.include_router(financial_years_router, prefix="/financial-years", tags=["Financial Years"])
...
api_router.include_router(recurring_vouchers_router, prefix="/recurring-vouchers", tags=["Recurring Vouchers"])
api_router.include_router(voucher_templates_router, prefix="/voucher-templates", tags=["Voucher Templates"])
...
api_router.include_router(gst_registrations_router, prefix="/gst/registrations", tags=["GST Registrations"])
...
# Financial Reports
api_router.include_router(financial_reports_router, prefix="/reports", tags=["Financial Reports"])
