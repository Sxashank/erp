...
@router.get("/ap-summary", summary="AP Aging Summary")
async def get_ap_aging_summary(
    ...
    return await service.get_ap_aging_summary(
        organization_id=organization_id, as_of_date=as_of_date, vendor_id=vendor_id
    )


@router.get("/ar-summary", summary="AR Aging Summary")
async def get_ar_aging_summary(
    ...
    return await service.get_ar_aging_summary(
        organization_id=organization_id, as_of_date=as_of_date, customer_id=customer_id
    )


@router.get("/ap-detail/{vendor_id}", summary="AP Aging Detail")
async def get_ap_aging_detail(
    ...
    return await service.get_ap_aging_detail(
        organization_id=organization_id, vendor_id=vendor_id, as_of_date=as_of_date
    )


@router.get("/ar-detail/{customer_id}", summary="AR Aging Detail")
async def get_ar_aging_detail(
    ...
    return await service.get_ar_aging_detail(
        organization_id=organization_id, customer_id=customer_id, as_of_date=as_of_date
    )
