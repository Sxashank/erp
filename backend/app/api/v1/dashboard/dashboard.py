...
async def get_ap_summary(
    ...
    service = DashboardService(db)
    return await service.get_ap_summary(organization_id)


@router.get(
    "/ar-summary",
    response_model=ARSummary,
...
async def get_ar_summary(
    ...
    service = DashboardService(db)
    return await service.get_ar_summary(organization_id)
...
async def get_cashflow_summary(
    ...
    service = DashboardService(db)
    return await service.get_cashflow_summary(organization_id)
...
async def get_trends(
    ...
    service = DashboardService(db)
    return await service.get_trends(organization_id, months)
...
async def get_recent_activity(
    ...
    service = DashboardService(db)
    return await service.get_recent_activity(organization_id, limit)
...
async def get_pending_approvals(
    ...
    service = DashboardService(db)
    return await service.get_pending_approvals(organization_id, current_user.id)
